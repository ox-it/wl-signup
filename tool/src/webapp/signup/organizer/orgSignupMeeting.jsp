						   						...
						   						<h:panelGrid columns="2" columnClasses="editAddImages,attName"  rendered="#{attendeeWrapper.signupAttendee.attendeeUserId !=null}" id="editLink">
						   							...
						   							<h:panelGroup>
							   							<h:commandLink action="#{OrganizerSignupMBean.viewAttendeeComment}">
							   								...
							   								<h:graphicImage title="Click to view/edit attendee's comment" value="/images/comment.gif" width="18" height="18" alt="view comment" style="border:none" styleClass="openCloseImageIcon" rendered="#{EditCommentSignupMBean.comment}" />
							   							</h:commandLink>
						   							</h:panelGroup>
						   						</h:panelGrid>
